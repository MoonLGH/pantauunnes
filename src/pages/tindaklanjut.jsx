        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <a className="text-sm font-semibold text-gray-900 hover:text-yellow-600 transition-colors" href="#/tindak-lanjut">Tindak Lanjut</a>
              <a className="text-sm font-medium text-gray-600 hover:text-gray-900 transition-colors" href="#/struktur-komisi">Struktur Komisi</a>
            </div>
